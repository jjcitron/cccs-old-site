...
<form action="submit.php" method="post" usetooltips"false' id="form">
        <div class="top">
            <p>Tengo <span class="amt" id="debtAmount">$7000</span> en deudas <span class="locate">(Ajustar Barra)</span></p>
        ...
        <input type="text" id="firstname" class="formInput" name="firstname" pattern="^[A-Za-z]+$" value="" onchange="check(this)" placeholder="Nombre"  required/>
        <input type="text" id="lastname" class="formInput" name="lastname" pattern="^[A-Za-z]+$" value="" onchange="check(this)"  placeholder="Apellido"  required/>
        <input type="tel" id="phone_home" class="formInput" name="phone_home" pattern="^(?:(?:\+?1\s*(?:[.-]\s*)?)?(?:\(\s*([2-9]1[02-9]|[2-9][02-8]1|[2-9][02-8][02-9])\s*\)|([2-9]1[02-9]|[2-9][02-8]1|[2-9][02-8][02-9]))\s*(?:[.-]\s*)?)?([2-9]1[02-9]|[2-9][02-9]1|[2-9][02-9]{2})\s*(?:[.-]\s*)?([0-9]{4})(?:\s*(?:#|x\.?|ext\.?|extension)\s*(\d+))?$" name="phone_home"  value="" onchange="check(this)" placeholder="Tel&#233;fono" required/>
        <input type="tel" id="phone_work" class="formInput" name="phone_work" pattern="^(?:(?:\+?1\s*(?:[.-]\s*)?)?(?:\(\s*([2-9]1[02-9]|[2-9][02-8]1|[2-9][02-8][02-9])\s*\)|([2-9]1[02-9]|[2-9][02-8]1|[2-9][02-8][02-9]))\s*(?:[.-]\s*)?)?([2-9]1[02-9]|[2-9][02-9]1|[2-9][02-9]{2})\s*(?:[.-]\s*)?([0-9]{4})(?:\s*(?:#|x\.?|ext\.?|extension)\s*(\d+))?$" name="phone_home"  value="" onchange="check(this)" placeholder="Tel&#233;fono Alternativo" />
        <input type="email" id="email" class="formInput" name="email" value="" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" placeholder="Email"   required onchange="check(this)" required/>
		...
		<div class="ticker">
			<div class="form_con">
				<p class="title">Usted no est&#225; s&#243;lo<span class="ico"></span></p>
        ...
        <div class="formLower">
            <div class="formLeft">
                <div class="checkBox">
                    ...
                    <div class="formCheckLabel">Subscribirse al E-news</div>
                </div>
                <div class="checkBox">
                    <input type="checkbox" id="language" class="formCheckBox" name="language" value="sp" />
                    <div class="formCheckLabel">Prefer to Speak English</div>
                </div>
            </div>
            <div class="formRight">
			...
			<br style="clear:both">
			<div class="eKomi" id="eKomiWidget_default" style="top:142px"></div>
        </div>
