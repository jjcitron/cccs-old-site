<div class="theForm">
	...
	<fieldset>
		...
		<div class="phoneContainer">
			<input class="form-control"  type="tel" pattern="^(?:(?:\+?1\s*(?:[.-]\s*)?)?(?:\(\s*([2-9]1[02-9]|[2-9][02-8]1|[2-9][02-8][02-9])\s*\)|([2-9]1[02-9]|[2-9][02-8]1|[2-9][02-8][02-9]))\s*(?:[.-]\s*)?)?([2-9]1[02-9]|[2-9][02-9]1|[2-9][02-9]{2})\s*(?:[.-]\s*)?([0-9]{4})(?:\s*(?:#|x\.?|ext\.?|extension)\s*(\d+))?$" name="phone" value="" placeholder="Phone Number*" required/>
			<select  class="form-control" name="phonetype" required>
				<option value="cell">Cell</option><option value="home">Home</option><option value="work">Work</option>
			</select>
		</div>
