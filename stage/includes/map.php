...
switch($location){
	...
	case 'ok.php':
		...
		break;
	case 'nd.php':
		$locName = 'North Dakota';
		$theLatLon = '47.448933, -100.330367';
		$neBounds = '51.009370, -93.826445';
		$swBounds = '43.545093, -109.635302';
		$theZoom = '6';
		break;
	case 'sd.php':
	...
	case 'dc.php':
		$locName = 'DC';
		$theLatLon = '38.907343, -77.035511';
		$neBounds = '40.716832, -74.003760';
		$swBounds = '36.174568, -86.798491';
		$theZoom = '7';
		break;
	case 'nm.php':
		$locName = 'New Mexico';
		$theLatLon = '34.120759, -106.167543';
		$neBounds = '39.669011, -99.993226';
		$swBounds = '27.834068, -114.187562';
		$theZoom = '6';
		break;
	case 'wy.php':
		$locName = 'Wyoming';
		$theLatLon = '42.992948, -107.495127';
		$neBounds = '46.849252, -100.837412';
		$swBounds = '36.195915, -115.229502';
		$theZoom = '6';
		break;
	case 'al.php':
		$locName = 'Alabama';
		$theLatLon = '32.913716, -86.749111';
		$neBounds = '35.948659, -83.936611';
		$swBounds = '27.583274, -91.352382';
		$theZoom = '6';
		break;
	case 'ia.php':
		$locName = 'Iowa';
		$theLatLon = '41.997940, -93.484564';
		$neBounds = '44.541218, -88.035345';
		$swBounds = '38.494082, -100.779485';
		$theZoom = '6';
		break;
	case 'florida.php':
	default:
...
<?php
	if($lang=='es'){echo '<div class="mapTitle">Algunos Residentes de &nbsp;<span>&nbsp;'.$locName.'&nbsp;</span>&nbsp;que hemos ayudado...</div>';}
		else{echo '<div class="mapTitle">Some&nbsp;<span>&nbsp;'.$locName.'&nbsp;</span>&nbsp;Residents we\'ve hepled...</div>';}
?>
